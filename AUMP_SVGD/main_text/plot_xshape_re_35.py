...
if __name__ == "__main__":
   ...
   # torch.manual_seed(seed)
    ...
    torch.save(list_norm, "norm_xshape_110_test.pt")
    torch.save(list_gr_var, "gr_xshape_110_test.pt")
    torch.save(list_tr, "tr_xshape_110_test.pt")
    torch.save(list_eig, "eig_xshape_1110_test.pt")
    torch.save(list_energy, "energy_xshape_1110_test.pt")