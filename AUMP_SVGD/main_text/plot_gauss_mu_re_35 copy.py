...
if __name__ == "__main__":
    ...
    correlation=0.01
        ...
        lr = 0.01
        theta= etmySVGD(kernel,device,distribution).update(x0,  k = 2, n_iter = 5000,   lr= lr)
        ...
        theta = etmySVGD(kernel,device,distribution).update(x0, k = 3, n_iter = 5000,   lr= lr)
        ...
        lr = 0.01
        theta = etmySVGD(kernel,device,distribution).update(x0,  k = 5, n_iter = 5000,   lr= lr)
    ...
    torch.save(list_norm, "norm_gauss_mu_vs_110.pt")
    torch.save(list_gr_var, "gr_gauss_mu_vs_110.pt")
    torch.save(list_tr, "tr_gauss_mu_vs_110.pt")
    torch.save(list_eig, "eig_gauss_mu_vs_110.pt")
    torch.save(list_energy, "energy_gauss_mu_vs_110.pt")